Enumerates lattice points $\\{x\in\mathbb{Z}^{\text{dim}}: Hx>\text{rhs}\\}$ for $H\in\mathbb{Z}^{N,\text{dim}}$ and $\text{rhs}\in\mathbb{Z}$.
...
$$ \\{x\in\mathbb{Z}^{\text{dim}}: Hx>\text{rhs} \text{ and } |x|_\infty \leq B\\}. $$
